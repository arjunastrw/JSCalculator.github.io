        ...
        return _createClass(Calculator, [{
            ...
            value: function(e) {
                if (!this.state.currentVal.includes("Limit")) {
                    ...
                    r.length > 21 ? this.maxDigitWarning() : n ? this.setState({
                        currentVal: i,
                        formula: "0" !== i ? i : ""
                    }) : this.setState({
                        currentVal: "0" === r || isOperator.test(r) ? i : r + i,
                        formula: "0" === r && "0" === i ? "" === a ? i : a : /([^.0-9]0|^0)$/.test(a) ? a.slice(0, -1) + i : a + i
                    })
                }
            }
        }, {
            ...
            value: function() {
                return React.createElement("div", null, React.createElement("div", {
                    ...
                    className: "author"
                }, " ", "Designed By ", React.createElement("br", null), React.createElement("a", {
